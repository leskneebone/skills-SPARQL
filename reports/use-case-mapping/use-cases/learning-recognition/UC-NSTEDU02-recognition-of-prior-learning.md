...
- Institutions: VET provider(s), University provider(s), regulators; reference sources/employers
- Why now: need for consistent, explainable RPL decisions supported by portable evidence

## 3. Actors and Stakeholders
### Actors
- Prospective student
- Prospective VET or university institution (assessor)
...
- Reference sources (employers, industry bodies, portfolios)
...
## 6. Baseline Process
- Student provides narratives/portfolios/references
...
- Map claimed skills to skill entities
...
- Inconsistent mapping from work skills to education outcomes
...
- Provenance for mapping sources and assessor decisions

## 13. Enabling Assets
- NST skills concept scheme(s)
- Occupation/skills alignment artefacts (e.g., occupation profiles, ESCO alignments)
- Provenance model for evidence and mappings
- Profile/validator for consistent structure

## 14. Success Criteria
- More consistent RPL outcomes across assessors
...
|---|---|
| Skills as reusable entities | NST SKOS concepts |
| Evidence attachment | schema:citation / dcterms:references patterns |
| Validation status | (define minimal pattern; could be SKOS notes or a small evidence model) |
